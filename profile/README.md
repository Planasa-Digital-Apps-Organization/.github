...
- **`.github`** (este repo) — defaults org-wide: reusable workflows, catálogo declarativo de labels, community files heredados. Ver [ADR 0003](https://github.com/Planasa-Digital-Apps-Organization/claude-sanbox/blob/master/docs/adr/0003-org-github-repo-for-reusable-workflows.md).

## Doctrina

- **Branching**: git-flow lite, master-based. Toda short-lived branch nace de `master`. `develop` es vehículo de release. Detalle en el [runbook](https://github.com/Planasa-Digital-Apps-Organization/claude-sanbox/blob/master/docs/runbooks/git-flow.md).
